...
### Баг-лист (чтобы поправить на будущее)

- `style.bundle.js` -- поправить
...
![img.png](public_html/assets/img/img.png)
...
- Структура HTML-страницы. Объектная модель документа (DOM).s
